...
function createGlanceBookmarklet(){
    ...
    glanceBookmarkletLoader = function() {
        ...
        //getURL("https://rawgit.com/yuvallanger/Glance-Bookmarklet/master/glance-bookmarklet.html", function(data){

        getURL("https://rawgit.com/yuvallanger/Glance-Bookmarklet/dev/glance-bookmarklet.html", function(data){
